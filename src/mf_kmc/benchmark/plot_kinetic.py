...
def plot_benchmark_real_problems(results_path: str) -> None:
    ...
    plots_path = Path("plots/kinetic")

    os.makedirs(plots_path, exist_ok=True)

    files = os.listdir(results_path)

    to_plot = ["sf_EI", "mf_EI", "sf_MES", "mf_MES", "random"]
    ...
    for simulation in SIMULATIONS:
        ...
        plt.title(f"MIT Kinetic 2", fontsize=30)
        ...
        plt.savefig(f"{plots_path}/plot_kinetic_{results_path.name}.png")
        plt.savefig(f"{plots_path}/plot_kinetic.svg")
        ...
        ax.spines["top"].set_visible(False)
        ax.spines["right"].set_visible(False)
        plt.savefig(f"{plots_path}/plot_queries_kinetic.png")
        plt.savefig(f"{plots_path}/plot_queries_kinetic.svg")
...
if __name__ == "__main__":
    ...
    # plot_benchmark_real_problems("benchmark/results_kinetic_0.4")
    plot_benchmark_real_problems("benchmark/results_kinetic")
    # plot_benchmark_real_problems("benchmark/results_kinetic_0.1")
